...
#'
#' @references
#' Jean V. Adams (2019). EchoNet2Fish: Estimate Fish Abundance from Acoustic Echoes and Net Catch. R
#' package version 0.3.3.9000. https://github.com/dmwarn/EchoNet2Fish
#'
